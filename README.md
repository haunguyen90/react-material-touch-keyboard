...
[![npm version](https://badge.fury.io/js/react-material-touch-keyboard.svg)](https://badge.fury.io/js/react-material-ui-keyboard)
[![license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/haunguyen90/react-material-touch-keyboard)
...
This is an extended project from https://github.com/NoHomey/react-material-ui-keyboard. I modified it as the way I need.
Big thank to @NoHomey for building it.
...
```bash
$ npm install react-material-touch-keyboard
```

[![NPM](https://nodei.co/npm/react-material-touch-keyboard.png?downloads=true&stars=true)](https://nodei.co/npm/react-material-touch-keyboard/)
